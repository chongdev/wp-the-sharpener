...
if ( $personal ) {
	...
	if ( isset( $pchart ) && ! empty( $pchart ) ) {
		...
		$html .= '<p></p><p></p><p></p><p></p><p></p><p></p><table><tr><td><h3 style="text-decoration:none;background-color:#fff;color:black;text-align:center;">' . __( 'Personal Chart', MODAL_SURVEY_TEXT_DOMAIN ) . '</h3></td><td><h3 style="text-decoration:none;background-color:#fff;color:black;text-align:center;">' . __( 'Global Chart', MODAL_SURVEY_TEXT_DOMAIN ) . '</h3></td></tr><tr><td>' . $pchart0 . '</td><td>' . $pchart1 . '</td></tr></table>';
	}
	...
	foreach ( $survey_exp[ 'questions' ] as $qkey=>$questions ) {
		...
		foreach ( $questions as  $key=>$answer ) {
			if ( is_numeric( $key ) ) {
				...
				if ( in_array( "totalvotes", $cpdf_iexp ) ) {
					$current_vote = '
					<p style="text-decoration:none;background-color:#fff;color:black;">' . ( in_array( "otheranswers", $cpdf_iexp ) ? $marker : "" ) . $key . '. ' . ( isset( $legend[ $qid ][ $key - 1 ]) ? $legend[ $qid ][ $key - 1 ] : '' ) . ' ' . $answer[ 'answer' ] . ' <br><small>' . $answer[ 'count' ] . ' ' . $vtstring . ', ' . $answer[ 'percentage' ] . '% ' . __( 'of total votes', MODAL_SURVEY_TEXT_DOMAIN ) . $score . '</small><br>' . $admin_comment . ' </p>';
				}
				else {
					$current_vote = '
