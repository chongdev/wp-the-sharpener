	...
	**/
		...
		function enqueue_admin_custom_scripts_and_styles() {
			...
			wp_localize_script( 'modal_survey_admin', 'sspa_params', array( 
				...
				"languages"=>array( "chartalready" => __( 'Another chart has been already added!', MODAL_SURVEY_TEXT_DOMAIN ),
									 ...
									 "conditionemptyorconflict" => __( 'Advanced conditions bulk set is empty or it has a conflict. Each advanced conditions must contain AND or OR statements only, it is not possible to mix them in the same condition!', MODAL_SURVEY_TEXT_DOMAIN ),
									 "conditionmissingandor" => __( 'Missing AND/OR from the end of the bulk condition set!', MODAL_SURVEY_TEXT_DOMAIN ),
									 "conditionalreadyhasandor" => __( 'The bulk set already has AND/OR statement at the end, please add a condition or rebuild the set.', MODAL_SURVEY_TEXT_DOMAIN ),
									 ...
									 "advcondblockedit" => __( 'Editing Advanced Condition is not available, please remove and add it again.', MODAL_SURVEY_TEXT_DOMAIN ),			 
									 "correctanswers" => __( 'Correct Answers', MODAL_SURVEY_TEXT_DOMAIN ),
									 "score" => __( 'Score', MODAL_SURVEY_TEXT_DOMAIN ),
									 "avgscore" => __( 'Average Score', MODAL_SURVEY_TEXT_DOMAIN ),
									 ...
									 "alreadydatea" => __( 'You already added a date answer to this question.', MODAL_SURVEY_TEXT_DOMAIN ),
									 "alreadynuma" => __( 'You already added a numeric answer to this question.', MODAL_SURVEY_TEXT_DOMAIN ),
									 "alreadyselecta" => __( 'You already added a select answer to this question.', MODAL_SURVEY_TEXT_DOMAIN ),
									 "openta" => __( 'Open Text Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "typea" => __( 'Type your answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "minvalue" => __( 'Minimum value', MODAL_SURVEY_TEXT_DOMAIN ),
									 "maxvalue" => __( 'Maximum value', MODAL_SURVEY_TEXT_DOMAIN ),
									 "stepvalue" => __( 'Step', MODAL_SURVEY_TEXT_DOMAIN ),
									 "listvalues" => __( 'List of values', MODAL_SURVEY_TEXT_DOMAIN ),									 
									 "selectvalues" => __( 'Enter comma separated list of the selectable values', MODAL_SURVEY_TEXT_DOMAIN ),
									 "selectdate" => __( 'Select a date', MODAL_SURVEY_TEXT_DOMAIN ),
									 "selectnum" => __( 'Set the number', MODAL_SURVEY_TEXT_DOMAIN ),
									 "selectanswer" => __( 'Select from the list', MODAL_SURVEY_TEXT_DOMAIN ),
									 "answer_normal_title" => __( 'Normal Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "answer_opentext_title" => __( 'Open Text Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "answer_date_title" => __( 'Date Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "answer_numeric_title" => __( 'Numeric Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "answer_select_title" => __( 'List Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 ...
									 "revert" => __( 'Yes, I want the default configuration.', MODAL_SURVEY_TEXT_DOMAIN ),
									 ...
									 "addanswer_numeric" => __( 'Numeric Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "addanswer_date" => __( 'Date Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 "addanswer_select" => __( 'List Answer', MODAL_SURVEY_TEXT_DOMAIN ),
									 ...
									 "back_button" => __( 'BACK', MODAL_SURVEY_TEXT_DOMAIN ),
									 "admincomment" => __( 'Admin Comment', MODAL_SURVEY_TEXT_DOMAIN ),
									 "admincomment_placeholder" => __( 'Enter answer comment to appear on the reports or leave it empty.', MODAL_SURVEY_TEXT_DOMAIN ),
									 "play_survey" => __( 'PLAY SURVEY', MODAL_SURVEY_TEXT_DOMAIN ),
									 "close_survey" => __( 'CLOSE SURVEY', MODAL_SURVEY_TEXT_DOMAIN )
									)
				) );
		...
		**/
		...
		$settings_page = '';
			...
			add_settings_field('modal_survey-setting_save_ip', __( 'Save IP Address', MODAL_SURVEY_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'modal_survey', 'modal_survey-section', array('field' => 'setting_save_ip', 'field_value' => '', 'options' => array(__( 'On', MODAL_SURVEY_TEXT_DOMAIN )=>"on",__( 'Off', MODAL_SURVEY_TEXT_DOMAIN )=>"off"), 'other' => '', 'extrahtml' => '<div class="arrow_box"><p>' . __( 'Turning ON or OFF saving the IP Address of the participants', MODAL_SURVEY_TEXT_DOMAIN ) . '</p></div>'));
			...
			add_settings_field('modal_survey-setting_restapi', __( 'Rest API', MODAL_SURVEY_TEXT_DOMAIN ), array(&$this, 'settings_field_input_radio'), 'modal_survey', 'modal_survey-section', array('field' => 'setting_restapi', 'field_value' => '', 'options' => array(__( 'On', MODAL_SURVEY_TEXT_DOMAIN )=>"on",__( 'Off', MODAL_SURVEY_TEXT_DOMAIN )=>"off"), 'other' => '', 'extrahtml' => '<div class="arrow_box"><p>' . __( 'Turning ON or OFF providing Endpoints for Rest API', MODAL_SURVEY_TEXT_DOMAIN ) . '</p></div>'));
			add_settings_field('modal_survey-setting_restapi_privileges', __( 'Rest  API Privileges', MODAL_SURVEY_TEXT_DOMAIN ), array(&$this, 'settings_field_input_select'), 'modal_survey', 'modal_survey-section', array('field' => 'setting_restapi_privileges', 'field_value' => '', 'other' => 'restapi_privileges', 'extrahtml' => '<div class="arrow_box2"><p>' . __( 'Configure the access to the Rest API data', MODAL_SURVEY_TEXT_DOMAIN ) . '</p></div>'));
		...
		**/
		public function settings_field_input_select( $args ) {
			...
			elseif ( $args['other'] == 'restapi_privileges' ) {
					echo sprintf('<select name="%s" id="%s">', $field, $field);
					echo('<option value="administrator" ' . selected( $value, 'administrator', false ) . '>' . __( 'Administrator', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('<option value="public" ' . selected( $value, 'public', false ) . '>' . __( 'Public - Without Login', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('<option value="editor" ' . selected( $value, 'editor', false ) . '>' . __( 'Editor', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('<option value="author" ' . selected( $value, 'author', false ) . '>' . __( 'Author', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('<option value="contributor" ' . selected( $value, 'contributor', false ) . '>' . __( 'Contributor', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('<option value="subscriber" ' . selected( $value, 'subscriber', false ) . '>' . __( 'Subscriber', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('<option value="superadmin" ' . selected( $value, 'superadmin', false ) . '>' . __( 'Super Admin', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>' );
					echo('</select>');				
			}
...
//				$headers[] = 'MIME-Version: 1.0' . '\r\n';
				...
				$message .= "<p>" . __( 'Final Score', MODAL_SURVEY_TEXT_DOMAIN ) . ": " . $final_score . "
					" . __( 'Correct Answers', MODAL_SURVEY_TEXT_DOMAIN ) . ": " . $correct_answers . "
					
					" . __( 'Participant votes marked with grey rows.', MODAL_SURVEY_TEXT_DOMAIN ) . " <a target='_blank' href='" . admin_url( "admin.php?page=modal_survey_participants&msuid=" . $puid->autoid . "-" . $survey_id . "" ) . "'>" . __( 'Click here to see the full details.', MODAL_SURVEY_TEXT_DOMAIN ) . "</a></p>
					...
					foreach( $aids as $key => $aid_item ) {
						...
						if ( get_option( 'setting_save_votes' ) == 'on' && isset( $msuser_cookie ) ) {
							...
							if ( get_option( 'setting_save_ip' ) == "off" ) {
								$userip = __( 'disabled', MODAL_SURVEY_TEXT_DOMAIN );
							}
							else {
		...
		public function ajax_survey() {
			...
			if ( $_REQUEST['sspcmd'] == "getapiinfo" ) {
				...
				if ( isset( $_REQUEST[ 'options' ] ) ) {
					$survey_options = $_REQUEST[ 'options' ];
				}
				else {
					$survey_options = "";
				}
