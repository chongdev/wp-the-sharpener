...
<div id="modal_survey_accordion">
			...
			<div class="configuration_accordion"><h4>' . __( 'General Behavior', MODAL_SURVEY_TEXT_DOMAIN ) . '</h4><div>
				<div>
					...
					<div class="modal_survey_sliders full"><input value="' . __( 'Display Timer:', MODAL_SURVEY_TEXT_DOMAIN ) . ' ' . $options[ 135 ] . 'sec" type="text" style="width:150px;" class="modal_survey_display_timer_value" /><div class="modal_survey_display_timer modal_survey_tooltip" title="' . __( 'Delay time to display the survey.', MODAL_SURVEY_TEXT_DOMAIN ) . '"></div></div>
					<div class="modal_survey_sliders full"><input value="' . __( 'Quiz Timer:', MODAL_SURVEY_TEXT_DOMAIN ) . ' ' . $options[ 156 ] . 'sec" type="text" style="width:150px;" class="modal_survey_quiz_timer_value" /><div class="modal_survey_quiz_timer modal_survey_tooltip" title="' . __( 'Increase it above 0sec to enable Quiz Timer.', MODAL_SURVEY_TEXT_DOMAIN ) . '"></div></div>
					...
					<div class="modal_survey_checkbox"><label class="text modal_survey_tooltip" title="' . __( 'Show Admin Comments in the next question based on the selection, eg.: Correct or Wrong Answer', MODAL_SURVEY_TEXT_DOMAIN ) . '" style="width: 200px;"><input type="checkbox" name="show_admin_comments" ' . $opt_163 . ' class="inputtext show_admin_comments ms-checkbox" value="' . $options[ 163 ] . '" /> ' . __( 'Show Comments', MODAL_SURVEY_TEXT_DOMAIN ) . '</label></div>
					</div>
					<input type="button" class="default-settings button-primary" value="' . __( 'Revert back to the Default Settings', MODAL_SURVEY_TEXT_DOMAIN ) . '">
					</div>
			</div>
			<div class="configuration_accordion style-configuration"><h4>' . __( 'Style and Appearance', MODAL_SURVEY_TEXT_DOMAIN ) . '</h4><div>
				<div>		
					<div class="text">' . __( 'Theme:', MODAL_SURVEY_TEXT_DOMAIN ) . '
					<select name="survey_theme" class="survey_theme">
						<option '.selected( $options[ 171 ], "", false ).' value="">' . __( 'Default - Custom', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
						<option '.selected( $options[ 171 ], "theme-1", false ).' value="theme-1">' . __( 'Theme 1 - Purple', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
						<option '.selected( $options[ 171 ], "theme-2", false ).' value="theme-2">' . __( 'Theme 2 - Blue', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
						<option '.selected( $options[ 171 ], "theme-3", false ).' value="theme-3">' . __( 'Theme 3 - Green', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
						<option '.selected( $options[ 171 ], "theme-4", false ).' value="theme-4">' . __( 'Theme 4 - Yellow', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
						<option '.selected( $options[ 171 ], "theme-5", false ).' value="theme-5">' . __( 'Theme 5 - Red', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
						<option '.selected( $options[ 171 ], "theme-6", false ).' value="theme-6">' . __( 'Theme 6 - Dark Blue', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
					</select>
					<div id="theme_preview"><img src="' . plugins_url( "/assets/img/theme_preview$options[171].jpg", __FILE__ ) . '">
					</div>
					</div> 
					<div class="text style-theme-specific">' . __( 'Colors:', MODAL_SURVEY_TEXT_DOMAIN ) . '
					...
					<select name="next_button_style" class="next_button_style">
						...
						<option ' . selected( $options[ 151 ], "2", false ) . ' value="2">' . __( 'At the Bottom - Full Width Button', MODAL_SURVEY_TEXT_DOMAIN ) . '</option>
					...
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Shadow Horizontal:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[ 128 ].'px" type="text" class="modal_survey_shadowh_value" /><div class="modal_survey_shadowh"></div></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Shadow Vertical:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[ 129 ].'px" type="text" class="modal_survey_shadowv_value" /><div class="modal_survey_shadowv"></div></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Shadow Blur:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[ 130 ].'px" type="text" class="modal_survey_shadowb_value" /><div class="modal_survey_shadowb"></div></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Shadow Spread:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[ 131 ].'px" type="text" class="modal_survey_shadows_value" /><div class="modal_survey_shadows"></div></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Border Width:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[6].'px" type="text" class="modal_survey_border_width_value" /><div class="modal_survey_border_width"></div></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Border Radius:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[7].'px" type="text" class="modal_survey_border_radius_value" /><div class="modal_survey_border_radius"></div></div>
					<div style="clear:both;"></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Line Height:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[10].'px" type="text" class="modal_survey_line_height_value" /><div class="modal_survey_line_height"></div></div>
					<div class="modal_survey_sliders half style-theme-specific"><input value="' . __( 'Padding:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[9].'px" type="text" class="modal_survey_padding_value" /><div class="modal_survey_padding"></div></div>
					<div class="modal_survey_sliders full"><input value="' . __( 'Font Size:', MODAL_SURVEY_TEXT_DOMAIN ) . ' '.$options[8].'px" type="text" class="modal_survey_font_size_value" /><div class="modal_survey_font_size"></div></div>
					<div style="clear:both;"></div>
			...
			<div class="configuration_accordion"><h4>' . __( 'Miscellaneous', MODAL_SURVEY_TEXT_DOMAIN ) . '</h4><div>
				<div>			
					<div class="text style-theme-specific">' . __( 'Preloader:', MODAL_SURVEY_TEXT_DOMAIN ) . '<br>
			...
			<div class="modal_survey_checkbox-advanced"><label class="text modal_survey_tooltip" title="' . __( 'Uncheck if you want to apply the first true condition only.', MODAL_SURVEY_TEXT_DOMAIN ) . '" style="width: 200px;"><input type="checkbox" name="allconditions" ' . $opt_162 . ' class="inputtext allconditions ms-checkbox" value="' . $options[ 162 ] . '" /> ' . __( 'Apply All Conditions', MODAL_SURVEY_TEXT_DOMAIN ) . '</label></div>
			<div class="new_condition_line">
				...
				<select class="conds">
					...
					<option value="avgscore">' . __( 'Average Score', MODAL_SURVEY_TEXT_DOMAIN ) . '</options>
					...
					foreach( $questions as $key=>$qv ) {
						print('<option value="questionanswer_' . ( $key + 1 ) . '">' . __( 'Question', MODAL_SURVEY_TEXT_DOMAIN ) . ' ' . ( $key + 1 ) . ' ' . __( 'Answer', MODAL_SURVEY_TEXT_DOMAIN ) . '</options>');
					}
					foreach( $questions as $key=>$qv ) {
				...
				<a href="#" class="button button-primary add_condition_advanced modal_survey_tooltip" title="' . __( 'Optionally you can build advanced conditions by adding the current conditions to a bulk set.', MODAL_SURVEY_TEXT_DOMAIN ) . '"> ' . __( 'ADD THIS AS ADVANCED CONDITION', MODAL_SURVEY_TEXT_DOMAIN ) . ' </a>
				<a href="#" class="button button-primary add_condition_and modal_survey_tooltip" title="' . __( 'Optionally you can build advanced conditions by adding AND statement to your current condition bulk set.', MODAL_SURVEY_TEXT_DOMAIN ) . '">+ AND</a>
				<a href="#" class="button button-primary add_condition_or modal_survey_tooltip" title="' . __( 'Optionally you can build advanced conditions by adding OR statement to your current bulk condition set.', MODAL_SURVEY_TEXT_DOMAIN ) . '">+ OR</a>
				<a href="#" class="button button-primary remove_lastcondition modal_survey_tooltip" title="' . __( 'Remove the last condition element that has been added to the bulk set', MODAL_SURVEY_TEXT_DOMAIN ) . '">REMOVE LAST</a>
				...
				foreach( $options[ 21 ] as $condkey => $conds ) {
					...
					if ( isset( $conds_c ) && empty( $cond_divider ) ) {
						foreach( $conds_c as $aclkey=>$acl ) {
							if ( $acl == "time" ) {
								$newline_str .= __( 'Time is Up', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
							}
							if ( $acl == "score" ) {
								$newline_str .= __( 'Final Score', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
							}
							if ( $acl == "avgscore" ) {
								$newline_str .= __( 'Average Score', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
							}
							if ( $acl == "correct" ) {
								$newline_str .= __( 'Correct Answers', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
							}
							...
							if ( strpos( $acl, 'questionanswer_' ) !== false ) {
								$conds_exp = explode( "_", $acl );
								$newline_str .= __( 'Question', MODAL_SURVEY_TEXT_DOMAIN ) . " " . $conds_exp[ 1 ] . " " . __( 'Answer', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
							}
							...
							if ( $acl != "time" ) {
								...
								if ( isset( $adv_cond_list2[ $aclkey ] ) ) {
									if ( $adv_cond_list2[ $aclkey ] == "higher" ) {
										$newline_str .= __( 'higher than', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
									}
									if ( $adv_cond_list2[ $aclkey ] == "equal" ) {
										$newline_str .= __( 'equal with', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
									}
									if ( $adv_cond_list2[ $aclkey ] == "lower" ) {
										$newline_str .= __( 'lower than', MODAL_SURVEY_TEXT_DOMAIN ) . " ";
									}
								}
					...
					print( '<div class="one_condition_line"><a href="#" class="edit_condition" data-cond="' . $condkey . '"><img class="modal_survey_tooltip" title="' . __( 'Edit Condition', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="' . plugins_url( '/assets/img/cond-edit.png' , __FILE__ ) . '"></a><a href="#" class="remove_condition" data-cond="' . $condkey . '"><img class="modal_survey_tooltip" title="' . __( 'Remove Condition', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="' . plugins_url( '/assets/img/icon-minus.png' , __FILE__ ) . '"></a><input type="hidden" class="packed_cond" value="' . $conds_n . '">' . $newline_str . '</div>' );
				}
			}
...
$ms_settings =   array(
	...
	'drag_drop_upload' => true //Enable Drag & Drop Upload Support
			...
			<div>
				...
				<div>
					<div>
						<label class="text modal_survey_tooltip" title="' . __( 'Enable Klick Tipp', MODAL_SURVEY_TEXT_DOMAIN ) . '" style="width: 200px;"><input type="checkbox" name="klicktipp_status" class="inputtext addmoreapi_klicktipp admincheckbox" '.$klicktipp.' value="'.$klicktipp_value.'" /> ' . __( 'Enable Klick Tipp', MODAL_SURVEY_TEXT_DOMAIN ) . '</label>
					</div>
					<div class="aright">
						<div class="text shortfield modal_survey_tooltip" title="' . __( 'Enter your Klick Tipp Username', MODAL_SURVEY_TEXT_DOMAIN ) . '">' . __( 'Klick Tipp Username', MODAL_SURVEY_TEXT_DOMAIN ) . ': <input type="text" name="shortfield" class="inputtext shortfield klicktipp_username" placeholder="Username" value="'.str_replace('"','\'',$options[168]).'" /></div>
						<div class="text shortfield modal_survey_tooltip" title="' . __( 'Enter your Klick Tipp Password', MODAL_SURVEY_TEXT_DOMAIN ) . '">' . __( 'Klick Tipp Password', MODAL_SURVEY_TEXT_DOMAIN ) . ': <input type="text" name="shortfield" class="inputtext shortfield klicktipp_password" placeholder="Password" value="'.str_replace('"','\'',$options[169]).'" /></div>
						<div class="text shortfield modal_survey_tooltip" title="' . __( 'Enter your Klick Tipp API Key', MODAL_SURVEY_TEXT_DOMAIN ) . '">' . __( 'Klick Tipp API Key', MODAL_SURVEY_TEXT_DOMAIN ) . ': <input type="text" name="shortfield" class="inputtext shortfield klicktipp_apikey" placeholder="API Key" value="'.str_replace('"','\'',$options[170]).'" /></div>
					</div>
				</div>
				<div>
					<div>
				...
				<div>
					<div>
						<label class="text modal_survey_tooltip" title="' . __( 'Enable Mailing Boss', MODAL_SURVEY_TEXT_DOMAIN ) . '" style="width: 200px;"><input type="checkbox" name="mailingboss_status" class="inputtext addmoreapi_mailingboss admincheckbox" ' . $mailingboss . ' value="'.$mailingboss_value.'" /> ' . __( 'Enable Mailing Boss', MODAL_SURVEY_TEXT_DOMAIN ) . '</label>
					</div>
					<div class="aright">
						<div class="text shortfield modal_survey_tooltip" title="' . __( 'Enter your Mailing Boss Integration Key', MODAL_SURVEY_TEXT_DOMAIN ) . '">' . __( 'Mailing Boss Integration Key', MODAL_SURVEY_TEXT_DOMAIN ) . ': <input type="text" name="shortfield" class="inputtext shortfield mailingboss_key" placeholder="Integration Key" value="'.str_replace('"','\'',$options[165]).'" /></div>
						<div class="text shortfield modal_survey_tooltip" title="' . __( 'Enter your Mailing Boss List ID', MODAL_SURVEY_TEXT_DOMAIN ) . '">' . __( 'Mailing Boss List ID', MODAL_SURVEY_TEXT_DOMAIN ) . ': <input type="text" name="shortfield" class="inputtext shortfield mailingboss_listid" placeholder="List ID" value="'.str_replace('"','\'',$options[166]).'" /></div>
					</div>
				</div>
				<div>
					<div>
						<label class="text modal_survey_tooltip" title="' . __( 'Enable Mailster', MODAL_SURVEY_TEXT_DOMAIN ) . '" style="width: 200px;"><input type="checkbox" name="mymail_status" class="inputtext addmoreapi_mymail admincheckbox" '.$mymail.' value="'.$mymail_value.'" /> ' . __( 'Enable Mailster', MODAL_SURVEY_TEXT_DOMAIN ) . '</label>
					</div>
					<div class="aright">
						<div class="text shortfield modal_survey_tooltip" title="' . __( 'Enter your Mailster List ID', MODAL_SURVEY_TEXT_DOMAIN ) . '"><a href="#" class="getapiinfo" data-apiid="mymaillists" title="' . __( 'Click here to get your Mailster Lists.', MODAL_SURVEY_TEXT_DOMAIN ) . '">' . __( 'Mailster List ID', MODAL_SURVEY_TEXT_DOMAIN ) . '</a>: <input type="text" name="shortfield" class="inputtext shortfield mymail_listid" placeholder="List ID" value="'.str_replace('"','\'',$options[95]).'" /></div>
					</div>
...
<div class="shortcode_section"><a href="#" class="help-dialog button button-primary" data-helpid="help3">' . __( 'Results', MODAL_SURVEY_TEXT_DOMAIN ) . ' </a><a href="#" class="help-dialog button button-primary" data-helpid="help1">' . __( 'Embed Mode', MODAL_SURVEY_TEXT_DOMAIN ) . ' </a><a href="#" class="help-dialog button button-primary" data-helpid="help2">' . __( 'Modal Mode', MODAL_SURVEY_TEXT_DOMAIN ) . ' </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
		...
		foreach( $questions as $key=>$qv ) {
			if ( $key > 0 ) {
				$rem_q = '<a class="add_question"><img class="remove_question modal_survey_tooltip" title="' . __( 'Remove Question', MODAL_SURVEY_TEXT_DOMAIN ) . '" id="remove_question_' . $sv->id . '_' . ( $key + 1 ) . '" src="' . plugins_url( '/assets/img/icon-minus.png' , __FILE__ ) . '"></a><a class="dup_question"><img class="duplicate_question modal_survey_tooltip" title="' . __( 'Duplicate Question', MODAL_SURVEY_TEXT_DOMAIN ) . '" id="duplicate_question_' . $sv->id . '_' . ( $key + 1 ) . '" data-qid="' . ( $key + 1 ) . '" src="'.plugins_url( '/assets/img/icon-duplicate.png', __FILE__ ).'"></a>';
			}
			else {
				$rem_q = '<a class="dup_question"><img class="duplicate_question modal_survey_tooltip" title="' . __( 'Duplicate Question', MODAL_SURVEY_TEXT_DOMAIN ) . '" id="duplicate_question_' . $sv->id . '_' . ( $key + 1 ) . '" data-qid="1" src="' . plugins_url( '/assets/img/icon-duplicate.png', __FILE__ ) . '"></a>';
			}
				...
				if ( isset( $aoptions[ 0 ] ) ) {
					...
					if ( $aoptions[ 0 ] == "open" || $aoptions[ 0 ] == "numeric" || $aoptions[ 0 ] == "date" || $aoptions[ 0 ] == "select" ) {
						...
						if ( empty( $answers_text ) ) {
							$open_answer_details .= '<tr><td>' . __( 'Empty list', MODAL_SURVEY_TEXT_DOMAIN ) . '</td></tr>';
						}
						else {
							foreach( $answers_text as $at ) {
								$open_answer_details .= '<tr><td><div data-id="' . $sv->id . '_' . $at->id . '" class="delete_open_answer"><img class="modal_survey_tooltip" title="' . __( 'Remove Open Answer', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="' . plugins_url( '/assets/img/icon-minus.png', __FILE__ ) . '"></div>' . $at->answertext . "</td><td>" . $at->count . '</td></tr>';
							}
						}
  ...
  <ul class="no-js">
		<li><span class="button button-primary">' . __( 'Export Answers', MODAL_SURVEY_TEXT_DOMAIN ) . '</span>
			<ul>
				...
				$answer_options = '<div class="ao-accordion oaa' . ( $key2 + 1 ) . ' oaa' . $sv->id . '_' . ( $key2 + 1 ) . '"><h4>' . __( 'Answer Options', MODAL_SURVEY_TEXT_DOMAIN ) . '</h4><div><div class="answer_title">' . $answer_title . '</div><div class="left_aopts">' . $left_ans_options . $uploader . '<div class="img-pos-cont"><div class="optscontainer">' . __( 'Image Position:', MODAL_SURVEY_TEXT_DOMAIN ) . '</div>' . $imgpos_aopts . '</div></div><div class="right_aopts">' . $ans_options . '</div>' . $open_answer_details .'</div></div>';
				...
				if ( $key2 == 0 ) {
					print('<div class="default_answer"><a href="#" class="answer_options" data-aid="' . ($key2+1) . '"><img class="modal_survey_tooltip" title="' . __( 'Answer Options', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="'.plugins_url( "/assets/img/options.png" , __FILE__ ).'"></a>' . $answer_status . '<a class="modal_survey_tooltip whoansweredthis" title="' . __( 'Who answered this?', MODAL_SURVEY_TEXT_DOMAIN ) . '" href="' . $whoansweredthis . '"><span class="ans_nmo">' . ( $key2 + 1 ) . '.</span> ' . __( 'answer:', MODAL_SURVEY_TEXT_DOMAIN ) . '</a> <input type="text" name="answer[]" class="answer' . $answer_class . '" data-unique="'.$av->uniqueid.'" id="answer1" ' . $answer_type . ' value="' . htmlspecialchars( $av->answer ) . '" placeholder="' . __( 'no', MODAL_SURVEY_TEXT_DOMAIN ) . '" /><span id="answer_count1" class="answer_count" contenteditable="true">'.$av->count.' - '.$percentage.'%</span><a class="add_answer"><img class="modal_survey_tooltip" title="' . __( 'Add New Answer', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="'.plugins_url( "/assets/img/icon-plus.png" , __FILE__ ).'"></a>' . $answer_options . '</div>');
				}
				else {
					print('</span><div class="added_answers" id="answer_element_'.$sv->id.'_'.($key2+1).'"><a href="#" class="answer_options" data-aid="' . ($key2+1) . '"><img class="modal_survey_tooltip" title="' . __( 'Answer Options', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="' . plugins_url( "/assets/img/options.png", __FILE__ ) . '"></a>' . $answer_status . '<a class="modal_survey_tooltip whoansweredthis" title="' . __( 'Who answered this?', MODAL_SURVEY_TEXT_DOMAIN ) . '" href="' . $whoansweredthis . '"><span class="ans_nmo">' . ( $key2 + 1 ) . '.</span> ' . __( 'answer:', MODAL_SURVEY_TEXT_DOMAIN ) . '</a> <input type="text" name="answer[]" data-unique="'.$av->uniqueid.'" class="answer' . $answer_class . '" id="answer'.($key2+1).'" ' . $answer_type . ' value="' . htmlspecialchars( $av->answer ) . '" placeholder="' . __( 'no', MODAL_SURVEY_TEXT_DOMAIN ) . '" /><span id="answer_count'.($key2+1).'" class="answer_count" contenteditable="true">'.$av->count.' - '.$percentage.'%</span><a class="remove_answer" id="remove_answers_'.$sv->id.'_'.($key2+1).'"><img class="modal_survey_tooltip" title="' . __( 'Remove Answer', MODAL_SURVEY_TEXT_DOMAIN ) . '" src="'.plugins_url( "/assets/img/icon-minus.png" , __FILE__ ).'"></a>' . $answer_options . '</div>');
				}
			}
			print('
		</div>
...
else
{
				...
				foreach($surveys as $sv)
				{
					...
					<td>
						<a href="Javascript: void(0);" class="modal_survey_tooltip duplicate_survey" title="' . __( 'Duplicate', MODAL_SURVEY_TEXT_DOMAIN ) . '" data-sid="'.$sv->id.'" data-sname="'.$sv->name.'"><img src="'.plugins_url( '/assets/img/icon-duplicate.png' , __FILE__ ).'"></a>
...
<div id="dialog-confirm11" title="<?php _e( 'Reverting back the changes', MODAL_SURVEY_TEXT_DOMAIN );?>?">
  <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span><?php _e( 'All settings in the General Behavior, Style and Appearance and in the Miscellaneous section will be reverting back to the original values. You still have to save the changes. Are you sure you want to do this?', MODAL_SURVEY_TEXT_DOMAIN );?></p>
</div>
