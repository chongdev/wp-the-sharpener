...
class Wonderwall_Magazine_Updater_Admin {
	...
	function updater() {
		...
		if ( !class_exists( 'Wonderwall_Magazine_Updater' ) ) {
			// Load our custom theme updater
			include( get_template_directory() . '/inc/mt-updater-class.php' );
		}

		new Wonderwall_Magazine_Updater(
			array(
	...
	function activate_license() {
		...
		if ( is_wp_error( $response ) || 200 !== wp_remote_retrieve_response_code( $response ) ) {
			...
			if ( false === $license_data->success ) {
				...
				if ( ! empty( $message ) ) {
					$base_url = admin_url( 'themes.php?page=wonderwall-magazine-getting-started' );
		...
		wp_redirect( admin_url( 'themes.php?page=wonderwall-magazine-getting-started' ) );
		exit();
 ...
 */
function wonderwall_magazine_updater_admin_notices() {
...
add_action( 'admin_notices', 'wonderwall_magazine_updater_admin_notices' );