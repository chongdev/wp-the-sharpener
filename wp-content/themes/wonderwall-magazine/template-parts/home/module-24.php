...
?>
	...
	<div class="module-wrapper module-24-wrapper <?php if ( $section_info['spacing'] == 'enabled' ) echo 'module-with-spacing'; ?>">

		<div class="wrapper clearfix">
			
			<div class="module-24 col col-8">
				...
				<div class="module-posts-listing module-24-posts-listing" data-id="module-24-posts-listing">
